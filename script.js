// 1. DATA PRODUK (Edit foto dan teks di sini)
const produk = [
    { nama: "Produk 1", desc: "Detail Produk 1", img: "https://images.unsplash.com/photo-1614680376593-902f74cf0d41?q=80&w=400" },
    { nama: "Produk 2", desc: "Detail Produk 2", img: "https://images.unsplash.com/photo-1558494949-ef010958384e?q=80&w=400" },
    // Tambahkan sampai 10 produk dengan format yang sama
];
...
produk.forEach(p => {
    ...
    div.className = 'card';
    div.onclick = () => {
        // Logika Toggle: Kalau aktif, hapus class aktif. Kalau mati, tutup semua lalu aktifkan satu.
...
// 2. 5 KETERANGAN LAYANAN
const ket = document.getElementById('keterangan-layanan');
for(let i=1; i<=5; i++) {
    ket.innerHTML += `<div class="step-item"><h3>Keterangan ${i}</h3><p>Penjelasan layanan.</p><img src="https://images.unsplash.com/photo-1611162617474-5b21e879e113?q=80&w=600" class="step-img"></div>`;
}

// 3. 5 KATALOG FOTO + TEXT
